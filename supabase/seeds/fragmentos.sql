...
insert into fragmentos (id, tema, titulo, texto, editado_por) values
  ...
  ('a9f10000-0000-4000-8000-000000000301', 'reserva-y-garantia', 'Pago y garantía',
   'No se deja seña: para reservar el traje se abona el 100% del alquiler, todo junto, en el local, en el mismo turno en que lo elegís. Se puede pagar en efectivo, con transferencia, con Mercado Pago, con tarjeta de débito o con tarjeta de crédito en un pago; también en tres cuotas con tarjeta de crédito —son las cuotas del banco—, con un 10% de recargo. El día de la prueba final se deja una tarjeta de crédito como garantía, también en el local. Por WhatsApp no se cobra ni se piden datos de tarjeta.',
   'respuestas de Sofía 17/9. Mercado Pago y "son cuotas del banco" confirmado por la dueña, 23/9 (antes no estaba Mercado Pago en la lista, y no se sabía si las tres cuotas eran del banco o propias; el 10% de recargo no cambió)'),
