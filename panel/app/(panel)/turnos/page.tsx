...
// El aviso de sincronización con Calendar va además del estado real del turno,
// nunca en su lugar (decisión #2 de Mateo, 12/9).
...
// El mock de lib/mock-data no trae el aviso: se suma acá hasta que paneles migre la columna `aviso`.
const AVISOS: Record<string, string> = { 'Nicolás Pereyra': 'Sin sincronizar con Google Calendar' };

const PASOS = ['Confirmado', 'Alquiló', 'Retiró', 'Devolvió'];
      ...
      <div className="hidden flex-1 flex-col px-6 pt-5.5 md:flex">
        ...
        {vacia ? (
          ...
          <>
            ...
            <div className="relative min-h-[720px] flex-1 overflow-hidden">
              <div className="absolute inset-0 flex">
                ...
                <div className="relative flex-1 border-l border-[#EFEBE2]">
                  <div className="absolute inset-x-0 top-[360px] flex h-20 items-center justify-center bg-[#EFEBE3] text-[14px] font-medium tracking-[.05em] text-[#8A8578] md:text-[11px]">
                    CERRADO 14–15
                  </div>
                ...
                <div className="relative flex-1 border-l border-[#EFEBE2]">
                  ...
                  <div className="absolute inset-x-1.5" style={{ top: 60 }}>
                    <BloqueTurno
                      ...
                      detalle="Invitado · 45’ · Sin confirmar"
                      estado="sin-confirmar"
                      aviso={AVISOS['Nicolás Pereyra']}
                    />
                  </div>
                  <div
                    className="absolute inset-x-1.5 flex h-[22px] items-center gap-2 overflow-hidden rounded-bloque border border-borde bg-lino px-2.5"
                    style={{ top: 520, borderLeft: '3px solid #5E7F62' }}
                  >
                    <span className="font-serif text-[14px] font-semibold md:text-[12.5px]">Lucas Amado</span>
                    <span className="text-[14px] text-grafito md:text-[11px]">Prueba final · 15’</span>
                  </div>
                </div>
        ...
        <div className="px-4 pb-3 pt-[18px]">
          <div className="flex items-center">
            <div className="flex-1">
              ...
              <div className="mt-0.5 text-[14px] text-grafito">Sábado 12 de septiembre</div>
            </div>
          ...
          <>
              ...
              {turnosM.map((t) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {AVISOS[t.n] && <div className="mt-0.5 text-[14px] font-medium text-ambar">↻ {AVISOS[t.n]}</div>}
                  </div>
            ...
            <div className="rounded-t-2xl bg-lino px-[18px] pb-[30px] pt-5 shadow-otto-pop">
              ...
              <div className="flex items-baseline gap-2.5">
                ...
                <span className="rounded-pill bg-salvia-suave px-2.5 py-[3px] text-[14px] font-medium text-salvia">Confirmado</span>
              </div>
