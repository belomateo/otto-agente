// scripts/probar-turno.js — los 15 guiones de scripts/guiones-agente.cjs (AGENTE.md § 13, más
// evento-manana-deriva de la decisión #8 del 14/9) contra el emulador `probar-agente` (H1.7).
//
