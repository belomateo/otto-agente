...
| 16 | El proyecto de Supabase de Otto vive en la cuenta de Sofia (`sofi_hernando@hotmail.com`, org `ibjwydxrjumjnpabbnzp`, proyecto `fhyuvdliwppqkneddezn`, región us-east-2), no en la cuenta principal de Mateo — decisión explícita del 12/9 al arrancar Fase 0 | Todo lo que usa Supabase | Mateo (con Sofia) |
